...
(async () => {
  ...
  await convert("src/apps/imgs", "src/.vuepress/public/build/imgs");
  await convert("src/dev/imgs", "src/.vuepress/public/build/imgs");
  await convert("src/guide/imgs", "src/.vuepress/public/build/imgs");
  await convert("src/setup/imgs", "src/.vuepress/public/build/imgs");
  await convert("src/tip/imgs", "src/.vuepress/public/build/imgs");
})();
